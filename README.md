...
Bash understands a whole host of standard Linux commands or can run any command stored in an executable file. In addition, Bash can also execute shell scripts (text files that contain Linux commands). 
</p>
